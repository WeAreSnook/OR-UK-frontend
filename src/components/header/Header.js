  ...
  return (
    <header className="global-header" role="banner">
      <div className="global-header__top-container page-container">
        ...
        <LinkExternal link={forumLink} rel="noreferrer" styleName="forum-link button button-secondary button-header show-md" />
        <LinkExternal link={developersLink} rel="noreferrer" styleName="button button-secondary button-header show-md" />
      </div>
      <Navigator onClick={toggleClass} mainMenu={mainMenu} topMenuId={topMenuId.toString()} menuButton={isActive} forumLink={forumLink} developersLink={developersLink} />
    </header>
  );
}
